...
public class DbConnection {
    ...
    static {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/notebank?useUnicode=true&useJDBCCompliantTimeZoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
