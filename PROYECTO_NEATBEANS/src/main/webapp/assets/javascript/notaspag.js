...
function cargarPaginacion( indice, cantidad){
        $.ajax({
            ...
            data.notas.forEach( function(valor, indice) {
                str+='<form class="containerDASHBOARD" action="EditNoteController?idNota='+valor.idNota+' " method="POST"> <div class="alinearB"> <input type="submit" class="BotonE" value="..."></div> <h4>¡Notebank!</h4> <input type="hidden" name="idNota" value="'+valor.idNota+'"> <p>'+valor.descripcion+' </p>  </form>';
